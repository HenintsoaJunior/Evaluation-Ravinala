...
const ResultSummaryNonCadre = () => {
  ...
  const downloadExcel = () => {
    ...
    XLSX.writeFile(workbook, `Scores_NonCadre_${selectedYear.getFullYear()}.xlsx`);
    handleMenuClose();
  };
  ...
  const downloadPDF = () => {
    ...
    doc.save(`Scores_NonCadre_${selectedYear.getFullYear()}.pdf`);
    handleMenuClose();
  };
...
export default ResultSummaryNonCadre;